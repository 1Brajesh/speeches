...
- As of 2026-05-20:
  ...
  - Focus Compare includes a sticky selection toolbar and a sticky Saved Lines drawer so highlighted lines can be saved/copied without scrolling back to the top or bottom.
...
- The speeches page currently cache-busts the module URL in `index.html`:
  - `./assets/js/brajesh-speeches.js?v=20260602e`
