...
- As of 2026-05-20:
  ...
  - Saved Lines cards default to a tight text-only collapsed view; expanding a line reveals source metadata and actions.
...
- The speeches page currently cache-busts the module URL in `index.html`:
  - `./assets/js/brajesh-speeches.js?v=20260602m`
